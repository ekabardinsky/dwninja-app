import {
    ...
    CHANGE_VALUE_CURRENT_VARIABLE, CLOSE_ALERT, CLOSE_DW_GENERATOR, CLOSE_RUNNING_SPLASH, CREATE_COLLECTION, CREATE_LAB,
    CREATE_VARIABLE, DELETE_COLLECTION, DELETE_LAB,
    EVALUATION_END,
    EVALUATION_STARTED,
    GET_EVALUATORS, LOAD_STATE, OPEN_ALERT, OPEN_DW_GENERATOR, OPEN_RUNNING_SPLASH, PARSE_PROPERTY_FILE_RESULT,
...
export const openDwGenerator = payload => ({
    type: OPEN_DW_GENERATOR,
    payload
});

export const closeDwGenerator = payload => ({
    type: CLOSE_DW_GENERATOR,
    payload
});